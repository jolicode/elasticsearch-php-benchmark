...
do
    ...
    ./console run elasticsearch persistent --hide-errors=1 > /dev/null 2>&1
    printf "."

    ./bin/load-data.sh > /dev/null 2>&1
    ./console run sherlock persistent --hide-errors=1 > /dev/null 2>&1
    printf "."

    ./bin/load-data.sh > /dev/null 2>&1
    ./console run elastica persistent --hide-errors=1 > /dev/null 2>&1
    printf "."

    ./bin/load-data.sh > /dev/null 2>&1
    ./console run nervetattoo persistent --hide-errors=1 > /dev/null 2>&1
    printf "."
done
